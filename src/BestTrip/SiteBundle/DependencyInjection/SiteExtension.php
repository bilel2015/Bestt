...
namespace BestTrip\SiteBundle\DependencyInjection;
...
class SiteExtension extends Extension
{
    ...
    {
        $definition = new Definition('BestTrip\SiteBundle\Twig\Extension\VarsExtension');
        ...
        $container->setDefinition('json_decoder', $definition);
