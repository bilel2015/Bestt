    ...
    a(document).ready(function () {
        function d() {
            a("#bars").on("click", function () {
                return 0 == a(".navigation").hasClass("nav-active") && a(".navigation").addClass("nav-active"), a("body").css({overflow: "hidden"}), !1
            }), a("#bars-close").on("click", function () {
                return a(".navigation").hasClass("nav-active") && a(".navigation").removeClass("nav-active"), a("body").css({overflow: "visible"}), !1
            }), a(".nav-l").closest("body").find(".bars").css({left: "15px", right: "auto"}), a(".nav-l").closest("body").find("#header .logo").css("margin-left", "50px")
        }
        ...
        function f() {
            var b = a(".navigation").data("menu-type"), d = window.innerWidth, e = a(".navigation"), f = a(".header");
            ...
            })) : (e.removeClass("nav").addClass("nav-desktop").closest(".header"), f.css("background-color", "#fff").find(".logo").css({opacity: "1", visibility: "visible"}), f.next().css("margin-top", a(".header").height()), a(".bars, .bars-close, .logo-banner").hide(), a(".navigation .sub-menu").each(function () {
                var b = a(this).offset().left, d = a(this).width(), e = c - (b + d);
        ...
        function g() {
            var b = a("#menu"), d = parseInt(b.attr("data-responsive"), 10), e = c, f = a(".header");
        ...
        function i() {
            var b = a(".dropdown-cn");
            b.each(function () {
                var d = a(this), e = d.find(".current > a").text();
        ...
        function j() {
            a(".select select").change(function () {
                var b = a(this), c = b.parent(".select").find("span"), d = b.find("option:selected").text();
                c.text(d)
            })
        }
        ...
        function k() {
            a(".form-field .field-input").on("keydown",function () {
                ...
                var b = a(this), c = b.parent(".form-field").find("label");
                "" != b.val() ? 0 == c.hasClass("forcus") && c.addClass("focus") : c.removeClass("focus")
            })
        }

        function l() {
            a(".calendar-input,.caneldar").datepicker({showOtherMonths: !0, selectOtherMonths: !0, dayNamesMin: ["Sun", "Mon", "Tue", "Wen", "Thu", "Fri", "Sta"]})
        }

        function m() {
            if (a("#owl-magazine-ds").length) {
                a("#owl-magazine-ds").owlCarousel({autoPlay: !1, slideSpeed: 500, navigation: !1, pagination: !1, mouseDrag: !1, addClassActive: !0, singleItem: !0, afterAction: function () {
        ...
        function p() {
            a(".time-slider").length && a(".time-slider").slider({min: 0, max: 1440, step: 1, create: function () {
                ...
                var f, g, h, i, j, d = a(this), e = d.slider("option", "range");
        ...
        function r() {
            ...
            function e(a) {
                var b = c.data("owlCarousel").owl.visibleItems, d = a, e = !1;
                for (var f in b)if (d == b[f])var e = !0;
            ...
            var b = a("#slide-room-lg"), c = a("#slide-room-sm");
            b.owlCarousel({singleItem: !0, autoPlay: !1, slideSpeed: 1e3, navigation: !1, pagination: !1, transitionStyle: "fade", afterAction: d}), c.owlCarousel({slideSpeed: 1e3, mouseDrag: !1, navigation: !0, navigationText: ["<span class='prev-next-room prev-room'></span>", "<span class='prev-next-room next-room'></span>"], itemsCustom: [
                [320, 3],
                [480, 5],
                [768, 6],
                [992, 7],
                [1200, 8]
            ], pagination: !1, afterInit: function (a) {
        ...
        function s() {
            a(".progress-rv").each(function () {
                var d = a(this).attr("data-value"), e = 10 * d;
                a(this).append("<div style='width:" + e + "%'><span>" + d + "</span></div>")
            })
        }

        function t() {
            a(".post-slide").length > 0 && a(".post-slide").owlCarousel({autoPlay: 8e3, slideSpeed: 1e3, navigation: !0, pagination: !1, singleItem: !0, autoHeight: !0, transitionStyle: "fade", navigationText: ["<i class='fa  fa-angle-left'></i>", "<i class='fa  fa-angle-right'></i>"]})
        }

        function u() {
            a(".page-slide").length > 0 && a(".page-slide").owlCarousel({autoPlay: 1e4, slideSpeed: 1e3, navigation: !1, pagination: !0, singleItem: !0, autoHeight: !0, navigationText: ["<i class='fa  fa-angle-left'></i>", "<i class='fa  fa-angle-right'></i>"]})
        }
        ...
        function w() {
            a(".scroll-table").length && (b.any() || a(".scroll-table").niceScroll({touchbehavior: !1, background: "#e2e2e2", cursoropacitymin: 1, cursorcolor: "#141414", ursoropacitymax: .6, cursorwidth: 5, cursorborder: "0px solid #fff", railalign: "right"}))
        }

        function x() {
            if (c >= 1200) {
                var b = a(window).scrollTop(), d = a("#header").outerHeight();
                a(".detail-cn").each(function () {
                    var f = a(this), g = f.offset().top, h = f.outerHeight(), i = f.find(".scroll-heading"), j = i.outerHeight(), k = b - g + d;
                    k > 0 ? h - k >= 0 && h - j > k ? i.css({position: "fixed", top: +d + "px"}) : i.css({position: "static"}) : i.css({position: "static"})
                }), a(".scroll-heading a").on("click", function () {
                    var b = a(this).attr("href");
                    return a("html, body").stop().animate({scrollTop: a(b).offset().top - 70}, 1e3), !1
                })
            }
        }
        ...
        function y() {
            a(".bar-cl .fill").each(function () {
                var b = a(this), c = b.attr("data-price"), d = 100 * (c / 600);
                b.css({height: d + "%"})
        ...
        function B() {
            if (a("#hotel-maps").length) {
                var b, c = new google.maps.LatLngBounds, d = {zoom: 16, scrollwheel: !1, mapTypeId: google.maps.MapTypeId.ROADMAP};
                ...
                ], g = new google.maps.InfoWindow({maxWidth: 600}), j = "images/icon-maker.png";
                for (i = 0; i < e.length; i++) {
                    var k = e[i], l = new google.maps.LatLng(k[1], k[2]);
                    c.extend(l), h = new google.maps.Marker({position: l, map: b, icon: j, title: k[0]}), google.maps.event.addListener(h, "click", function (a) {
                        return function () {
        ...
        function C() {
            if (a("#contact-maps").length) {
                var b = a("#contact-maps"), c = b.data("map-zoom"), d = b.data("map-latlng").split(",")[0], e = b.data("map-latlng").split(",")[1], f = b.data("map-content"), g = new google.maps.LatLng(d, e), h = {center: g, zoom: c, scrollwheel: !1, mapTypeId: google.maps.MapTypeId.ROADMAP}, i = new google.maps.Map(document.getElementById("contact-maps"), h), j = new google.maps.Marker({position: g});
                j.setMap(i);
                var k = new google.maps.InfoWindow({content: f, maxWidth: 200});
        ...
        d(), g(), i(), j(), k(), l(), m(), o(), p(), r(), w(), y(), s(), t(), u(), v(), B(), C(), D(), a(window).load(function () {
            ...
            var c = a(".navigation").data("menu-type"), d = window.innerWidth, e = a(window).scrollTop();
            c > d && 100 > e && a(".header").css("background-color", "transparent").find(".logo").css({opacity: "0", visibility: "hidden"})
        })
    })
}(jQuery);