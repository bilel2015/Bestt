!function (e) {
    ...
    e.fn.ajaxSubmit = function (a) {
        function r(t) {
            ...
            a.data = null;
            var o = e.extend(!0, {}, e.ajaxSettings, a, {contentType: !1, processData: !1, cache: !1, type: "POST"});
        ...
        function n(r) {
            ...
            function o() {
                ...
                var r = u.attr("target"), o = u.attr("action");
                T.setAttribute("target", d), i || T.setAttribute("method", "POST"), o != f.url && T.setAttribute("action", f.url), f.skipEncodingOverride || i && !/post/i.test(i) || u.attr({encoding: "multipart/form-data", enctype: "multipart/form-data"}), f.timeout && (y = setTimeout(function () {
                    b = !0, s(j)
                }, f.timeout));
                var l = [];
                try {
                    ...
                    if (L && L.location.href != f.iframeSrc || b) {
                        ...
                        try {
                            ...
                            if (d || f.textarea) {
                                ...
                                if (g)h.responseText = g.value, h.status = Number(g.getAttribute("status")) || h.status, h.statusText = g.getAttribute("statusText") || h.statusText; else if (d) {
                                    var x = L.getElementsByTagName("pre")[0], T = L.getElementsByTagName("body")[0];
            ...
            var l, c, f, m, d, p, v, h, g, x, b, y, T = u[0], S = !!e.fn.prop;
            if (r)if (S)for (c = 0; c < r.length; c++)l = e(T[r[c].name]), l.prop("disabled", !1); else for (c = 0; c < r.length; c++)l = e(T[r[c].name]), l.removeAttr("disabled");
            ...
            if (f = e.extend(!0, {}, e.ajaxSettings, a), f.context = f.context || f, d = "jqFormIO" + (new Date).getTime(), f.iframeTarget ? (p = e(f.iframeTarget), x = p.attr("name"), null == x ? p.attr("name", d) : d = x) : (p = e('<iframe name="' + d + '" src="' + f.iframeSrc + '" />'), p.css({position: "absolute", top: "-1000px", left: "-1000px"})), v = p[0], h = {aborted: 0, responseText: null, responseXML: null, status: 0, statusText: "n/a", getAllResponseHeaders: function () {
            ...
            if (!h.aborted) {
                ...
                var j = 1, k = 2, w = e("meta[name=csrf-token]").attr("content"), D = e("meta[name=csrf-param]").attr("content");
                D && w && (f.extraData = f.extraData || {}, f.extraData[D] = w), f.forceSync ? o() : setTimeout(o, 10);
                var A, L, E, M = 50, F = e.parseXML || function (e, t) {
                    return window.ActiveXObject ? (t = new ActiveXObject("Microsoft.XMLDOM"), t.async = "false", t.loadXML(e)) : t = (new DOMParser).parseFromString(e, "text/xml"), t && t.documentElement && "parsererror" != t.documentElement.nodeName ? t : null
                }, X = e.parseJSON || function (e) {
        ...
        var i, o, s, u = this;
        "function" == typeof a && (a = {success: a}), i = this.attr("method"), o = this.attr("action"), s = "string" == typeof o ? e.trim(o) : "", s = s || window.location.href || "", s && (s = (s.match(/^([^#]+)/) || [])[1]), a = e.extend(!0, {url: s, success: e.ajaxSettings.success, type: i || "GET", iframeSrc: /^https/i.test(window.location.href || "") ? "javascript:false" : "about:blank"}, a);
        var l = {};
        ...
        var h = e("input:file:enabled[value]", this), g = h.length > 0, x = "multipart/form-data", b = u.attr("enctype") == x || u.attr("encoding") == x, y = !!(g && h.get(0).files && window.FormData);
        t("fileAPI :" + y);
        var T = (g || b) && !y;
        ...
        return this.ajaxFormUnbind().bind("submit.form-plugin",function (t) {
            ...
            var i = this;
            if (i.clk = a, "image" == a.type)if (void 0 != t.offsetX)i.clk_x = t.offsetX, i.clk_y = t.offsetY; else if ("function" == typeof e.fn.offset) {
                var o = r.offset();
        ...
        if (!n)return a;
        var i, o, s, u, l, c, f;
        for (i = 0, c = n.length; c > i; i++)if (l = n[i], s = l.name)if (t && r.clk && "image" == l.type)l.disabled || r.clk != l || (a.push({name: s, value: e(l).val(), type: l.type}), a.push({name: s + ".x", value: r.clk_x}, {name: s + ".y", value: r.clk_y})); else if (u = e.fieldValue(l, !0), u && u.constructor == Array)for (o = 0, f = u.length; f > o; o++)a.push({name: s, value: u[o]}); else null !== u && "undefined" != typeof u && a.push({name: s, value: u, type: l.type});
        if (!t && r.clk) {
            var m = e(r.clk), d = m[0];
            s = d.name, s && !d.disabled && "image" == d.type && (a.push({name: s, value: m.val()}), a.push({name: s + ".x", value: r.clk_x}, {name: s + ".y", value: r.clk_y}))
        }
        return a
        ...
        return this.each(function () {
            ...
            if (r) {
                ...
                if (n && n.constructor == Array)for (var i = 0, o = n.length; o > i; i++)a.push({name: r, value: n[i]}); else null !== n && "undefined" != typeof n && a.push({name: this.name, value: n})
            }
        }), e.param(a)
